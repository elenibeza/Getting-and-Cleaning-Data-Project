##creating the variable to download the data file
file <- "data.zip"
## please note I had to change the url from https to http because it was throwing error "unsupported URL Schema" when I tried with https
...
## Create data and folders and verifies the data zip file has been downloaded
if(!file.exists(file)){
...
##Reads and creates a complete dataset
...
##saves the data into the created result folder
...
# Save the finale tidy dataset in txt file  by running write.table() using row.name=FALSE
write.table(dataset2, "dataset3.txt", row.name=FALSE)
